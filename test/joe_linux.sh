...
llvm-as $1.ll
echo "running $2 pass..."
opt -load ../build/projects/poolalloc/Release+Debug+Asserts/lib/LLVMDataStructure.so -load ../llvm-cfi/build/Release+Debug+Asserts/lib/LLVM$2.so -$2 < $1.bc > $1_opt.bc
